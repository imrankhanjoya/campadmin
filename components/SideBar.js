...
export default function SideBar() {
  return (
       ...
       <div className="bg-white  w-20 flex-shrink-0 border-r border-gray-200 flex-col hidden sm:flex">
      ...
      <div className="flex mx-auto flex-grow mt-4 flex-col text-gray-400 space-y-4">
        <button className="h-10 w-12  rounded-md flex items-center justify-center">
        ...
        <button className="h-10 w-12  rounded-md flex items-center justify-center bg-blue-100 text-blue-500">
          <svg viewBox="0 0 24 24" className="h-5" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
